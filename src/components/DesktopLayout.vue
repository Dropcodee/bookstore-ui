      ...
      <a-row type="flex">
        ...
        <a-col :span="12">
          <div class="smallnav">
            ...
            <p class="smallnav__total">Showing {{ currentCategory.books.length || 0 }} Result(s)</p>
          </div>
        </a-col>
      </a-row>
    </a-layout-header>
      ...
      <a-layout-sider width="300" style="background: #fff">
        ...
        >
          <a-menu-item v-for="category in categories" :key="category">
            ...
            >
            {{ category.name }} <span class="opacity-50"
            :style="{ margin: '0 2em' }">{{ category.books.length || 0 }}</span>
          </a-menu-item>
        </a-menu>
      </a-layout-sider>
